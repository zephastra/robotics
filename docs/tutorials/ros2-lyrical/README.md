# ROS 2 Lyrical 非官方中文教程

这是一套面向 Ubuntu 26.04、ROS 2 Lyrical Luth 的非官方中文教程。内容以官方文档为主要来源，并加入必要的中文解释、版本差异说明和项目实践备注。

> 本教程由 Zephastra 独立整理，不是 ROS 2 官方中文站，也不是对官方文档的完整逐字翻译。遇到差异时，以每篇列出的官方原文和当前软件版本为准。
